...
audio_folder = r'/home/yolo/Desktop/Ensemble_testing/sample_audio'
output_file = r'/home/yolo/Desktop/Ensemble_testing/indic_conformer/IndicConformer/output.txt'

# Initialize the device and the model
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
model = EncDecCTCModel.restore_from(restore_path='/home/yolo/Desktop/Ensemble_testing/indic_conformer/IndicConformer/ai4b_indicConformer_hi.nemo')
model.freeze()
